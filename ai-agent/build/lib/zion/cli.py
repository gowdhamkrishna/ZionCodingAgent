...
def print_banner(provider: str, model_name: str):
    ...
    commands = [("paste", "multi-line"), ("$", "shell"), ("undo", "restore"), ("history", "versions"), ("clear", "screen"), ("exit", "quit")]
...
def main():
    ...
    workspace = os.getcwd()
    agent = AgentOrchestrator(base_dir=workspace, provider=provider, model_name=model_name)
